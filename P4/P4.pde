  ...
  for(int i = 0; i < 50; i++)  { 
    for(int j = 0; j < 50; j++)  {
      beginShape();
        ...
        vertex(-300 + i * 5, 50 + j * 5, 100, i/50.0, j/50.0);
        vertex(-295 + i * 5, 50 + j * 5, 100, (i+1)/50.0, j/50.0);
        vertex(-295 + i * 5, 55 + j * 5, 100, (i+1)/50.0, (j+1)/50.0);
        vertex(-300 + i * 5, 55 + j * 5, 100, i/50.0, (j+1)/50.0);
      endShape();
    }
  }
